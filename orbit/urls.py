...
urlpatterns = [
    ...
    path("ai/summarize/<uuid:entry_id>/", OrbitAISummaryView.as_view(), name="ai_summarize"),
    path("ai/triage/<uuid:entry_id>/", OrbitAITriageView.as_view(), name="ai_triage"),
    path("ai/search/", OrbitAISearchView.as_view(), name="ai_search"),
    # Actions
